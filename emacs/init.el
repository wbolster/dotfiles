...
(use-package dash
  :demand t
  :functions
  -contains-p -filter -first -flatten -last -map -map-when -partial
...
(use-package evil-goggles
  ...
  (dolist (item '((lispyville-yank                 :face evil-goggles-yank-face           :switch evil-goggles-enable-yank           :advice evil-goggles--generic-async-advice)
    ...
    (add-to-list 'evil-goggles--commands item))
