...
;; Package-Version: 20260630.859
;; Package-Revision: 8c0e048a771f
;; Package-Requires: ((emacs "28.1") (dash "2.18.0") (transient "0.3.7") (s "1.12.0"))
...
+ If the test function is defined inside a class that is defined
  ...
  (unless (python-pytest--point-is-inside-def-treesit)
    (error "Point is not inside a def"))
  (save-restriction
    (widen)
    (let ((function
...
+ If the class is defined inside another class, the node id of the
  ...
  (unless (python-pytest--point-is-inside-class-treesit)
    (error "Point is not inside a class"))
  (save-restriction
    (widen)
    (let ((class
           ;; Move up to the outermost function
...
variable."
  (cond
   ...
   (t (error "Could not determine project root"))))
