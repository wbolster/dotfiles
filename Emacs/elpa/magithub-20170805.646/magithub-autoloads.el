...
;;;***

;;;### (autoloads nil "magithub-cache" "magithub-cache.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from magithub-cache.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "magithub-cache" '("magithub-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "magithub-core" '("magithub-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "magithub-issue" '("magithub-")))
...
;;;***

;;;### (autoloads nil "magithub-issue-status" "magithub-issue-status.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from magithub-issue-status.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "magithub-issue-status" '("magit")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "magithub-label" '("magithub-")))
...
;;;***

;;;### (autoloads nil nil ("magithub-pkg.el") (0 0 0 0))
