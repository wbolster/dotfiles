...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "with-editor" '("with-editor" "server-switch-buffer--with-editor-server-window-alist" "start-file-process--with-editor-process-filter" "shell-command-")))
